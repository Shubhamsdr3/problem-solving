...
public class MinimumDistance {
    ...
    //O(n2)
    private static int minimumDistances1(int[] a) {
        boolean isPossible = false;
        int minDistance = Integer.MAX_VALUE;
